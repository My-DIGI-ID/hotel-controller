...
public class RevealedAttrValuesMasterId {
    ...
    @JsonProperty("hardwareDid")
    private Property hardwareDid;
    ...
    public String toString() {
        return "RevealedAttrValuesMasterId [addressCity=" + addressCity + ", addressCountry=" + addressCountry
                ...
                + familyName + ", firstName=" + firstName + ", dateOfBirth=" + dateOfBirth + ", dateOfExpiry="
                + dateOfExpiry + ", hardwareDid=" + hardwareDid + "]";
    }

    public Property getHardwareDid() {
        return hardwareDid;
    }

    public void setHardwareDid(Property hardwareDid) {
