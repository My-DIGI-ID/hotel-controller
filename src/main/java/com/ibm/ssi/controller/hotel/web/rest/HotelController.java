...
public class HotelController {
    ...
    public ResponseEntity<HotelDTO> createHotel(@Valid @RequestBody HotelDTO hotelDTO) {
        ...
        } catch (HotelAlreadyExistsException | HotelHasDesksWithDuplicateIdsException | HotelHasDesksWithDuplicateNamesException e) {
    ...
    public ResponseEntity<HotelDTO> updateHotel(@Valid @RequestBody HotelDTO hotelDTO) {
        ...
        } catch (HotelHasDesksWithDuplicateIdsException | HotelHasDesksWithDuplicateNamesException e) {
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, e.getMessage());
        }
    }
